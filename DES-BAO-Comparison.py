...
def calculate_HU_dm_rd(z):
    ...
    # HU specific calculation based on generation theory
...
for z in [0.65, 0.835, 1.02]:
    HU_val = calculate_HU_dm_rd(z)
    HU_unc = calculate_HU_uncertainty(z)
    print(f"z={z:.3f}: HU={HU_val:.3f} ± {HU_unc:.3f}")
